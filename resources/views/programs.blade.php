                ...
                @foreach ($programs as $program)
                    <div class="max-w-sm rounded overflow-hidden shadow-lg flex flex-col h-full">
                        ...
                        <div class="flex-grow pl-6 pr-6 pt-6 pb-2">
                            <h1 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ $program->title }}</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">by {{ $program->user->name }}</p>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Rp{{ $program->price }}</p>
                        </div>
